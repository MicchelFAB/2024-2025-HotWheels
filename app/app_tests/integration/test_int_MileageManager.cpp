...
protected:
  ...
  void SetUp() override {
    ...
    fileHandler =
        new MileageFileHandler("/home/hotweels/app_data/test_mileage.json");
    mileageManager = new MileageManager(
        "/home/hotweels/app_data/test_mileage.json", calculator, fileHandler);
  }
